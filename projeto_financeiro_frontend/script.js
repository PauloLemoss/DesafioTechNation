...
function carregarDados(periodo){
  ...
  } else if(periodo == "janeiro"){
    dataInicialFiltragem = "2023-01-01"
    dataFinalFiltragem = "2023-01-31"
  }  else if(periodo == "fevereiro") {
    dataInicialFiltragem = "2023-02-01"
    dataFinalFiltragem = "2023-02-28"
  } else if(periodo == "marco") {
    dataInicialFiltragem = "2023-03-01"
    dataFinalFiltragem = "2023-03-31"
  } else if(periodo == "abril") {
    dataInicialFiltragem = "2023-04-01"
    dataFinalFiltragem = "2023-04-30"
  } else if(periodo == "maio") {
    dataInicialFiltragem = "2023-05-01"
    dataFinalFiltragem = "2023-05-31"
  } else if(periodo == "junho") {
    dataInicialFiltragem = "2023-06-01"
    dataFinalFiltragem = "2023-06-30"
  } else if(periodo == "julho") {
    dataInicialFiltragem = "2023-07-01"
    dataFinalFiltragem = "2023-07-31"
  } else if(periodo == "agosto") {
    dataInicialFiltragem = "2023-08-01"
    dataFinalFiltragem = "2023-08-31"
  } else if(periodo == "setembro") {
    dataInicialFiltragem = "2023-09-01"
    dataFinalFiltragem = "2023-09-30"
  } else if(periodo == "outubro") {
    dataInicialFiltragem = "2023-10-01"
    dataFinalFiltragem = "2023-10-31"
  } else if(periodo == "novembro") {
    dataInicialFiltragem = "2023-11-01"
    dataFinalFiltragem = "2023-11-30"
  } else if(periodo == "dezembro") {
    dataInicialFiltragem = "2023-12-01"
    dataFinalFiltragem = "2023-12-31"
  } 
  limparDados()
  inicializarPagina()
